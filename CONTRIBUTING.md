...
5. I PR-beskrivningen: lista eventuella terminologival som krävt avvägning och referera till `docs/decision_log.md`.
...
2. Slå upp varje fackterm i `GLOSSARY.md`.
...
* Lägg till en rad i `decision_log.md` om valet är principiellt.
...
* **Redigera inte filerna i `data/source/`.** De är orörda original.
