# Svensk-engelsk ordlista för DigComp 3.0

Kontrollerad termlista. Varje post har engelska termen, svenska termen, kort definition, källa för den svenska termen samt beslutsdatum. Maskinläsbar version finns i `data/sv/glossary.json`.

## Status

*Preliminär. Markerade poster är fastställda; övriga kräver granskning.*
...
Källa: AI-förordningen använder "bias". Diskussionspost – se decision_log.md.
...
Källa: MSB använder "deepfake" oöversatt; Språkrådet föreslår "djupförfalskning". TBD.

**Digital citizenship** → **Digitalt medborgarskap**
Förmåga att delta aktivt, kontinuerligt och ansvarsfullt i samhällen, såväl online som offline, genom kompetent och positivt engagemang med digital teknik.
Källa: Europarådet (2022). ✅
...
Falsk eller vilseledande information som avsiktligt skapas och sprids för att bedra.
...
**Human-centric** → **Människocentrerad / människocentrerat**
Källa: AI-förordningen använder "människocentrerad". ✅
...
**Nudging** → **Nudging / knuffning**
TBD. "Nudging" används ofta oöversatt i svensk forskning.

## P

**Personal data** → **Personuppgifter**
Uppgifter som avser en fysisk person som kan identifieras direkt eller indirekt.
Källa: GDPR art. 4. ✅
...
**Privacy** → **Integritet / personlig integritet**
Kontextberoende. När det avser den juridiska rättigheten används "personlig integritet". När det avser praktisk kontroll över data används "integritet". ✅
